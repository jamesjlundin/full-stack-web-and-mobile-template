...
export const fixtures: Fixture[] = [
  ...
  },
  {
    ...
    category: "schema",
    prompt:
      "Generate a product listing with id, name, price, and inStock status",
    schema: {
      type: "object",
      properties: {
        id: { type: "string" },
  ...
  // Schema Trap Cases (designed to catch common errors)
  {
    ...
    category: "schema",
    prompt:
      "Generate an event with a nested address object containing street, city, and zip",
    schema: {
      type: "object",
      properties: {
        title: { type: "string" },
  ...
  },
  {
    ...
    category: "schema",
    prompt:
      "Generate a meeting with title, time, and an array of attendee emails",
    schema: {
      type: "object",
      properties: {
        title: { type: "string" },
